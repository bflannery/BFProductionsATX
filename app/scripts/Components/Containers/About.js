    ...
    return (
      <div className="about">
        <div className="about-container">
          ...
          <span>
            One of the greatest strengths about being a developer with a photography background is that not only do I enjoy being apart of and solving the technical challenges of a project, but also understand the visual aspects of those same projects.
          </span>
          <span>
